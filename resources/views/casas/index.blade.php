...
<section class="casas-header-section"
         style="padding:5rem 2rem;text-align:center;
                ...
                border-bottom:1px solid rgba(196, 165, 73, 0.15);">
...
$casas = [
    ...
    [
        ...
        'oferta'   => 'Diseño de Redes Logísticas: Crearás sistemas complejos de distribución que conectan empresas con clientes eficientemente.', 'Economía Circular: Aprenderás modelos sostenibles que minimizan residuos en la cadena de suministro.', 'Operación de Flotas y Terminales: Gestionarás flota de vehículos y centros de distribución de manera óptima.', 'Investigación de Operaciones Logísticas: Optimizarás rutas, costos y tiempo de entrega usando análisis cuantitativos.', 'Tendencias en la Cadena de Suministros: Te mantendrás actualizado en tecnologías emergentes como blockchain y IoT en logística.', 'Investigación de Operaciones Logísticas: Optimizarás rutas, costos y tiempo de entrega usando análisis cuantitativos.', 'Tendencias en la Cadena de Suministros: Te mantendrás actualizado en tecnologías emergentes como blockchain y IoT en logística.',
