...
<style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .page-wrap    { display:flex; flex-direction:column; min-height:calc(100vh - 54px); }
    .page-content { flex:1; }

    .hero-section  { padding:5rem 2rem; text-align:center; border-bottom:1px solid rgba(200,168,75,.15); }
    .hero-title    { font-size:3rem; }

    .explicacion-wrap { max-width:1200px; margin:3rem auto; padding:0 2rem; }

    .dominios-wrap { max-width:1400px; margin:auto; padding:0 2rem 4rem; }
    ...
    @media (max-width:900px)  { .dominios-grid { grid-template-columns:repeat(2,1fr); } }
    @media (max-width:560px)  { .dominios-grid { grid-template-columns:1fr; } }
    ...
    /* Imagen del dominio — misma presentación que el carrusel del welcome */
    .dominio-img-wrap {
        width:100%;
        aspect-ratio:1;
        overflow:hidden;
...
<div class="page-wrap">
    <div class="page-content">
        ...
        <section class="hero-section"
                 style="background:url('{{ asset('imagenes/dominios/hero-dominios.webp') }}');
            ...
            <h1 class="hero-title" style="color:#FFFFFF;font-family:'Headland One',serif;margin-bottom:1rem;">
                Dominios Académicos
            </h1>
        ...
        <div class="explicacion-wrap">
            <div style="background:rgba(6,6,15,.75);border:1px solid rgba(200,168,45,.15);
                ...
                <p style="color:#F0EAD8;line-height:1.9;margin:0;">
                    Los dominios agrupan carreras que comparten intereses, competencias y áreas
                    de conocimiento similares. Dentro de NOVA representan los grandes caminos
                    académicos que estructuran la identidad universitaria de cada estudiante.
                </p>
            </div>
        </div>
        ...
        <div class="dominios-wrap">
            <div class="dominios-grid">
                ...
                <div class="dominio-card">
                    ...
                    <div style="height:8px;background:{{ $dominio->color }};flex-shrink:0;"></div>

                    {{-- IMAGEN / LOGO DEL DOMINIO --}}
                    @if(!empty($dominio->imagen))
                        <div class="dominio-img-wrap">
                            <img src="{{ asset($dominio->imagen) }}" alt="{{ $dominio->nombre }}">
                        </div>
                    @else
                        <div class="dominio-img-placeholder">
                            <svg width="48" height="48" viewBox="0 0 24 24" fill="none"
                                 stroke="rgba(200,168,75,.25)" stroke-width="1.5">
                    ...
                    <div style="padding:1.5rem;display:flex;flex-direction:column;flex:1;">
                        ...
                        <h4 style="color:#C8A84B;font-size:1.1rem;margin-bottom:.25rem;
                                   font-family:'Headland One',serif;">
                            {{ $dominio->nombre_casa }}
                        </h4>

                        <h3 style="color:#FFFFFF;font-size:1rem;margin-bottom:.8rem;
                                   font-family:'Headland One',serif;">
                            {{ $dominio->nombre }}
                        </h3>

                        <p style="color:#B0A898;line-height:1.7;margin-bottom:1.5rem;flex:1;font-size:.9rem;">
                            {{ $dominio->descripcion }}
                        </p>
                        ...
                        <div style="display:flex;flex-wrap:wrap;gap:.5rem;">
                            ...
                            @empty
                            <span style="color:#707085;font-size:.78rem;font-style:italic;">
                ...
                <div style="grid-column:1 / -1;background:#14141F;
                    ...
                    <p style="color:#B0A898;margin:0;">No hay dominios académicos registrados.</p>
                </div>
                @endforelse
        ...
        <section class="cta-section">
            <h2 class="cta-title" style="color:#FFFFFF;font-family:'Headland One',serif;margin-bottom:1rem;">
                Descubre tu camino académico
            </h2>
            <p class="cta-desc" style="color:#F0EAD8;max-width:650px;margin:auto auto 2rem;line-height:1.8;">
            ...
            <a href="{{ route('quiz') }}" class="cta-btn"
