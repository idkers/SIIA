...
<img src="{{ asset('imagenes/isotipo_dorado.webp') }}"
    ...
    <div class="nav-links">
        ...
        <a href="{{ route('dominios') }}"  style="font-size:.88rem;color:#E8C96A;text-decoration:none;letter-spacing:.08em;text-transform:uppercase;">Dominios</a>
...
<div class="page-content">
    ...
    <div class="explicacion-wrap">
        <div style="background:#14141F;border:1px solid rgba(200,168,75,.15);
